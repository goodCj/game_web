...
const OtherGames = (props) => {
  ...
  const { cam = null, home = null, more = null, clean = null, scroll = null, sec = 10, first = null } = query;
  ...
  const getUrl =(id)=>{
    ...
    return `${newUrl}/detail?id=${id}&type=otherGames&cam=${cam}&home=${home}&more=${more}&clean=${clean}&sec=${sec}&first=${first}`
  }
